...
<div class="flex">
        ...
        <div id="modal" class="fixed inset-0 bg-black/50 hidden flex items-center justify-center">
            <div class="bg-white p-6 rounded-xl w-full max-w-xl">
                ...
                <form method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select name="habitat" id="" class="p-3 border rounded-lg">
  ...
  <?php
                    ...
                    <textarea name="description" placeholder="Description"
                              class="p-3 border rounded-lg md:col-span-2"></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow overflow-hidden">
                ...
                <div class="flex space-x-2">
                    <a href="modifier_animal.php?id=<?= $row['id_animal'] ?> " class="ml-16">

                       <button    class="flex-1 bg-blue-600 text-white py-2 rounded hover:bg-blue-700 px-2"> <i class="fas fa-edit mr-1"></i>Modifier </button> 
                    </a>
                  
                     <a href="supprimer_animal.php?id=<?= $row['id_animal'] ?>" class="ml-16">

                       <button    class="flex-1 bg-red-600 text-white py-2 rounded hover:bg-red-700 px-2"> <i class="fas fa-edit mr-1"></i>Supprimer </button> 
                    </a>
            <?php endwhile; ?>
